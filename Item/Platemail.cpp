...
bool Platemail::GetItem(Player * player)
{
...
void Platemail::Render()
{
	InventoryRender("Platemail");
}

void Platemail::EffectRender()
{
}

void Platemail::TileItemRender(D3DXVECTOR2 m_Pos, float m_Alpha)
{
	Image * img = IMGMANAGER->GetImage("Platemail");
